class LoadSong {
	...
	init(selectedSong, autoPlayEnabled, multiplayer, touchEnabled) {
		...
		this.progressText = document.querySelector("#loading-progress .progress-text")
		this.loadedAssets = 0
		this.totalAssets = 0
	...
	updateProgress() {
		if (this.progressBar) {
			var percentage = this.totalAssets === 0 ? 0 : Math.floor(this.loadedAssets * 100 / this.totalAssets)
